   ...
   <section class="main">
        <div class="navbar h-class">
            ...
            <div class="main-heading" id="main-heading">
                  ...
                  <div style="color:black; font-size:20px;"><button class="btn"><a href="signin.php" style="text-decoration:none;">Sign In to order tea</a></button></div>
            </div>
      ...
      <footer>
       ...
       <script src="./javascipr/main.js"></script>
</body>
</html>